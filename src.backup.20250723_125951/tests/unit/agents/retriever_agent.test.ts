...
describe('RetrieverAgent', () => {
  ...
  describe('query parsing', () => {
    it('should extract search query from_input, async () => {
      const_input= 'find information about machine learning algorithms';
    ...
    it('should handle quoted phrases as exact matches', async () => {
      const_input= 'search for "neural networks" and "deep learning"';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should extract constraints from query', async () => {
      const_input= 'find top 5 relevant documents about AI quickly';
      const response = await agent.processInput(input: mockContext;
  ...
  describe('retrieval strategies', () => {
    it('should use exact match strategy for quoted queries', async () => {
      const_input= 'find "exact phrase match" in documents';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should use parallel search for urgent queries', async () => {
      const_input= 'urgently find quick results about emergency protocols';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should use adaptive search for exploratory queries', async () => {
      const_input= 'explore and discover patterns in user behavior data';
      const response = await agent.processInput(input: mockContext;
  ...
  describe('source management', () => {
    it('should prioritize sources by reliability', async () => {
      const_input= 'find critical information about system configuration';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should filter sources based on constraints', async () => {
      const_input= 'find data from memory source only';
      const response = await agent.processInput(input: mockContext;
  ...
  describe('result ranking and filtering', () => {
    it('should rank results by relevance', async () => {
      const_input= 'find best practices for code optimization';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should filter results by minimum relevance', async () => {
      const_input= 'find highly relevant information about security protocols';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should limit results based on constraints', async () => {
      const_input= 'find top 3 resources about databases';
      const response = await agent.processInput(input: mockContext;
  ...
  describe('caching', () => {
    it('should cache successful retrieval results', async () => {
      const_input= 'find information about caching strategies';
    ...
    it('should respect cache TTL', async () => {
      ...
      const_input= 'find data with short cache';
  ...
  describe('performance optimization', () => {
    ...
    it('should complete retrieval within timeout', async () => {
      const_input= 'find information quickly within 500ms';
  ...
  describe('adaptive search', () => {
    it('should expand query terms when few results found', async () => {
      ...
      const_input= 'find rare information';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should adjust search depth based on initial results', async () => {
      const_input= 'explore adaptive search patterns';
      const response = await agent.processInput(input: mockContext;
  ...
  describe('complex queries', () => {
    it('should handle multi-constraint queries', async () => {
      const_input= 'find top 10 recent documents about AI from knowledge base with high relevance';
      const response = await agent.processInput(input: mockContext;
    ...
    it('should process natural language time constraints', async () => {
      const_input= 'quickly find data within 2 seconds';
      const startTime = Date.now();
