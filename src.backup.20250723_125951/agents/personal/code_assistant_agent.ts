...
export class CodeAssistantAgent extends BaseAgent {
    ...
    const config: AgentConfig = {
      ...
      capabilities: [
        ...
        },
        {
          ...
          description: 'Comprehensive project_analysisand health check',
          inputSchema: {
            type: 'object',
            properties: {
  ...
  protected async process(_context: AgentContext & { memoryContext?: any }): Promise<AgentResponse> {
    ...
    try {
      ...
      this.logger.error('CodeAssistantAgent proces, error;
      return {
        success: false,
        data: null,
   ...
   */
  private async parseCodeIntent(request: string): Promise<unknown> {
...
3. Include proper_errorhandling
...
- refactor: improve_errorhandling logic
...
Generate only the commit message:`;
      ...
      this.logger.error('Commit mes, error;
      return 'Update code';
    }
  }
  ...
  private detectLanguageFromFile(filePath: string {
  ...
  private async handleGeneralCodeQuery(request: string): Promise<unknown> {
