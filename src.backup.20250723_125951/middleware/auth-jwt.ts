...
export class JWTAuthService {
  ...
  public async refreshAccessToken(
    ...
    try {
      ...
      logger.error('Token refre, error;
      return null;
    }
  }
  ...
  private async storeRefreshToken(tokenData: RefreshTokenData)): Promise<void> {
    try {
      ...
      logger.error('Failed to store refre, error;
      throw error;
    }
  }
  ...
  private async getStoredRefreshToken(
    ...
    try {
      ...
      logger.error('Failed to get refre, error;
      return null;
    }
  }
  ...
  public async revokeRefreshToken(userId: string, tokenId: string)): Promise<void> {
    try {
      ...
      logger.error('Failed to revoke refre, error;
    }
  }
  ...
  public async revokeAllUserTokens(userId: string)): Promise<void> {
    try {
      ...
      logger.error('Failed to revoke all user token, error;
    }
  }
  ...
  public async cleanupExpiredTokens())): Promise<void> {
    try {
      ...
      if (_error: {
        logger.error('Failed to cleanup expired token, error;
      }
  ...
  private async updateUserActivity(
    ...
    try {
      ...
      logger.error('Failed to update u, error;
    }
  }
  ...
  public async revokeSession(userId: string, tokenId: string: Promise<boolean> {
    try {
      ...
      logger.error('Failed to revoke ses, error;
      return false;
    }
  }
}
