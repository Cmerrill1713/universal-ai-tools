...
router.post(
  ...
  wrapAsync(async (req, res) => {
    try {
      ...
      logger.error('PydanticAI reque, LogContext.API, {
...
router.post(
  ...
  wrapAsync(async (req, res) => {
    try {
      ...
      logger.error('Cognitive analysi, LogContext.API, {
        error: error instanceof Error ? error.message : String(error),
      });
      res.status(500).json({
        success: false,
...
router.post(
  ...
  wrapAsync(async (req, res) => {
    try {
      ...
      logger.error('Ta, LogContext.API, {
        error: error instanceof Error ? error.message : String(error),
      });
      res.status(500).json({
        success: false,
...
router.post(
  ...
  wrapAsync(async (req, res) => {
    try {
      ...
      logger.error('Schema regi, LogContext.API, {
        error: error instanceof Error ? error.message : String(error),
      });
      res.status(500).json({
        success: false,
...
router.get(
  ...
  wrapAsync(async (req, res) => {
    try {
      ...
      logger.error('Failed to get stat, LogContext.API, {
        error: error instanceof Error ? error.message : String(error),
      });
      res.status(500).json({
        success: false,
...
router.post(
  ...
  wrapAsync(async (req, res) => {
    try {
      ...
      logger.error('Structured reque, LogContext.API, {
        error: error instanceof Error ? error.message : String(error),
      });
      res.status(500).json({
        success: false,
