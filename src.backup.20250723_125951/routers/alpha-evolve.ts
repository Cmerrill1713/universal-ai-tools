...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      logger.error('Failed to submit ta, error;
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      logger.error('Failed to get task statu, error;
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      logger.error('Failed to get global statu, error;
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      logger.error('Failed to get cross-learning hi, error;
...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      logger.error('Failed to submit batch task, error;
...
/**
 * Get_pattern_analysisfor a specific_patterntype
 */
router.get(
