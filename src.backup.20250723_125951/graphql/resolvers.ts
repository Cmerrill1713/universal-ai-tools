  ...
  Query: {
    ...
    agentCoordination: async (parent, { agentIds }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching agent coordination data', {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    searchMemories: async (parent, { _input}, { supabase }) => {
      try {
        ...
        logger.error('Error searching memorie, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    knowledgeEntity: async (parent, { id }, { loaders }) => {
      try {
        ...
        logger.error('Error fetching knowledge entity', {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return null;
    ...
    knowledgeEntities: async (parent, { entityType, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching knowledge entitie, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    searchKnowledgeEntities: async (parent, { _input}, { supabase }) => {
      try {
        ...
        logger.error('Error searching knowledge entitie, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    findConnectedEntities: async (
      ...
      try {
        ...
        logger.error('Error finding connected entitie, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    knowledgeSnapshotAtTime: async (parent, { timestamp }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching knowledge snap, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    knowledgeEvolution: async (parent, { startTime, endTime }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching knowledge evolution', {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    systemHealth: async (parent, args, { supabase }) => {
      try {
        ...
        logger.error('Error fetching sy, LogContext.SYSTEM, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return {
  ...
  Mutation: {
    ...
    createKnowledgeEntity: async (parent, { _input}, { supabase, user }) => {
      try {
        ...
        logger.error('Error creating knowledge entity', {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    updateKnowledgeEntity: async (parent, { id, _input}, { supabase, user }) => {
      try {
        ...
        logger.error('Error updating knowledge entity', {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    deleteKnowledgeEntity: async (parent, { id }, { supabase, user }) => {
      try {
        ...
        logger.error('Error deleting knowledge entity', {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return false;
    ...
    createKnowledgeRelationship: async (parent, { _input}, { supabase, user }) => {
      try {
        ...
        logger.error('Error creating knowledge relation, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    updateKnowledgeRelationship: async (parent, { id, _input}, { supabase, user }) => {
      try {
        ...
        logger.error('Error updating knowledge relation, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    deleteKnowledgeRelationship: async (parent, { id }, { supabase, user }) => {
      try {
        ...
        logger.error('Error deleting knowledge relation, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return false;
    ...
    updateAgentStatus: async (parent, { id, status }, { supabase }) => {
      try {
        ...
        logger.error('Error updating agent statu, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        throw error;
    ...
    createMemory: async (
      parent,
      { content agentId, importance, temporalContext },
      { supabase }
    ) => {
      try {
  ...
  Agent: {
    ...
    knowledgeEntities: async (parent, args, { supabase }) => {
      try {
        ...
        logger.error('Error fetching agent knowledge entitie, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
  ...
  Memory: {
    connections: async (parent, args, { supabase }) => {
      try {
        ...
        logger.error('Error fetching memory connection, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
  ...
  KnowledgeEntity: {
    outgoingRelationships: async (parent, { types, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching outgoing relationship, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    incomingRelationships: async (parent, { types, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching incoming relationship, LogContext.DATABASE, {
          _error error instanceof Error ? error.message : String(_error,
          details: error
        });
        return [];
    ...
    causalEvent: async (parent, args, { supabase }) => {
      if (parent.causalEventId) {
        try {
          ...
          logger.error('Error fetching cau, LogContext.DATABASE, {
            _error error instanceof Error ? error.message : String(_error,
            details: error
          });
          return null;
