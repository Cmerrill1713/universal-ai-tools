...
export class DatabaseOptimizer {
  ...
  public async select<T = any>(
    ...
    try {
      ...
      logger.error(Database , LogContext.DATABASE, { error});
  ...
  public async insert<T = any>(
    ...
    try {
      ...
      logger.error(Database in, LogContext.DATABASE, { error});
  ...
  public async update<T = any>(
    ...
    try {
      ...
      logger.error(Databa, LogContext.DATABASE, { error});
      return { data: null, error};
    }
  }
  ...
  public async upsert<T = any>(
    ...
    try {
      ...
      logger.error(Database up, LogContext.DATABASE, { error});
      return { data: null, error};
    }
  }
