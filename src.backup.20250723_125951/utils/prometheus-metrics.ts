...
export class PrometheusMetricsCollector {
  ...
  constructor() {
    ...
    // Use lazy initialization_patterninstead
  }
  ...
  private collectSystemMetrics() {
    ...
    cpuUsagePercent.set(totalCpuTime / 1000000.id, totalCpuTime / 1000000); // Convert microseconds to seconds
  }
