...
export class PerformanceMonitor extends EventEmitter {
  ...
  async start())): Promise<void> {
    ...
    this.monitoringInterval = setInterval(async () => {
      try {
        ...
        logger.error('Error collecting system metric, error;
      }
  ...
  async measureAgent(agent: BrowserAgent: Promise<PerformanceReport> {
    ...
    try {
      ...
      logger.error(Performance mea, error;
  ...
  private async collectWebVitals(agent: BrowserAgent, metrics: PerformanceMetrics)): Promise<void> {
    try {
      ...
      logger.error('Failed to collect Web Vital, error;
      metrics.errors.push(
  ...
  private async collectMemoryUsage(
    ...
    try {
      ...
      logger.error('Failed to collect memory u, error;
      metrics.errors.push(
  ...
  private async collectNetworkMetrics(
    ...
    try {
      ...
      logger.error('Failed to collect network metric, error;
      metrics.errors.push(
  ...
  private async collectSystemMetrics())): Promise<void> {
    try {
      ...
      logger.error('Failed to collect system metric, error;
    }
  }
  ...
  async runChecks()): Promise<unknown> {
    ...
    try {
      ...
      logger.error('Performance check, error;
      return {
        duration: Date.now() - startTime,
