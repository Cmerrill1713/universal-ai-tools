...
export class RerankingService {
  ...
  private async featureBasedRerank(
    ...
    try {
      ...
      this.logger.error('Feature-ba, error;
      return this.fallbackReranking(results);
    }
  }
  ...
  private extractIntentKeywords(query: string[] {
  ...
  private getContentHash(content: string {
