...
export class EnhancedSupabaseService {
  ...
  public async listFiles(
    ...
    try {
      ...
      logger.error('Failed to list file, LogContext.STORAGE, { error});
      throw error;
    }
  }
  ...
  public async broadcastMessage(channel: string, event: string, payload: any)): Promise<void> {
    try {
      ...
      logger.error('Failed to broadcast mes, LogContext.REALTIME, { error});
      throw error;
    }
  }
  ...
  public async callEdgeFunction(options: EdgeFunctionCall): Promise<unknown> {
    try {
      ...
      logger.error('Failed to call edge function:', { error});
      throw error;
    }
  }
  ...
  public async semanticSearch(options: VectorSearchOptions: Promise<any[]> {
    try {
      ...
      logger.error('Failed to perform semantic , LogContext.DATABASE, { error});
      throw error;
    }
  }
  ...
  public async hybridSearch(
    ...
    try {
      ...
      logger.error('Failed to perform hybrid , LogContext.DATABASE, { error});
      throw error;
    }
  }
  ...
  public async createSignedUploadUrl(
    ...
    try {
      ...
      logger.error('Failed to create , LogContext.AUTH, { error});
      throw error;
    }
  }
  ...
  public async verifyResourceAccess(
    ...
    try {
      ...
      logger.error('Failed to verify resource acces, LogContext.AUTH, { error});
      return false;
    }
  }
  ...
  public async processFileWithFullPipeline(
    ...
    try {
      ...
      logger.error('Failed to proces, LogContext.AI, { error});
      throw error;
    }
  }
