...
process.env.// TODO: Refactor nested ternary
NODE_ENV = 'test';

describe('Knowledge Router - Simplified Tests', () => {
  let app: express.Application;
  let knowledgeStore: unknown[] = [];
  ...
  beforeEach(() => {
    ...
    app.post('/api/knowledge/search', (req, res) => {
      ...
      // Simple text search
      let results = knowledgeStore.filter(
        (item) =>
      ...
      // Apply limit
      results = results.slice(0, Math.min(limit, 100)); // Max 100 results
    ...
    app.delete('/api/knowledge/:id', (req, res) => {
      ...
      // Check if verified (prevent deletion)
    ...
    // GET /api/knowledge/type/:type - Get by type
  ...
  describe('DELETE /api/knowledge/:id', () => {
    ...
    it('should prevent deleting verified knowledge', async () => {
      // Add verified knowledge to store
      knowledgeStore.push({
