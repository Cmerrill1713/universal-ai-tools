...
export interface Evaluation.Criteria {
...
export interface Quality.Metrics {
...
export interface Evaluation.Report {
...
export interface Benchmark.Result {
  benchmark.Id: string;
  test.Suite: string;
  agent.Id: string;
  test.Cases: {
...
export class Evaluation.Agent extends Base.Agent {
  ...
  private async performComprehensive.Evaluation(context: Agent.Context): Promise<any> {
