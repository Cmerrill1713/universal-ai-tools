...
describe('DSPy.Knowledge.Manager', () => {
  ...
  describe('search.Knowledge', () => {
    it('should search by type', async () => {
      ...
      await kmstore.Knowledge(
        knowledge.Utilscreate.Knowledge('error instanceof Error ? error.message : String(error)  'Test Error', { error instanceof Error ? error.message : String(error)'test' }));
  ...
  describe('delete.Knowledge', () => {
    it('should delete knowledge', async () => {
      const id = await kmstore.Knowledge(
        knowledge.Utilscreate.Knowledge('error instanceof Error ? error.message : String(error)  'Test Error', { error instanceof Error ? error.message : String(error)'to be deleted' }));
