...
export class SweetAthenaWeb.Socket.Service.extends Event.Emitter {
  ...
  async start(server?: any): Promise<void> {
    try {
      ...
      loggererror('Failed to start Sweet Athena Web.Socket.service:', undefined, error instanceof Error ? error.message : String(error);
  ...
  async stop(): Promise<void> {
    try {
      ...
      loggererror('Error stopping Sweet Athena Web.Socket.service:', undefined, error instanceof Error ? error.message : String(error);
      throw error instanceof Error ? error.message : String(error)}}/**
  ...
  private async handle.Connection(ws: Authenticated.Web.Socket, req: any): Promise<void> {
    ...
    wson('error instanceof Error ? error.message : String(error)  (error instanceof Error ? error.message : String(error)=> thishandle.Error(ws, client.Id, error instanceof Error ? error.message : String(error)// Setup authentication timeout;
  ...
  private async handle.Message(
    ...
    try {
      ...
      loggererror('Error handling Web.Socket.message:', undefined, { error instanceof Error ? error.message : String(error) client.Id });
  ...
  private async handle.Auth(
    ...
    try {
      ...
      const { data: user, error instanceof Error ? error.message : String(error)  = await supabase;
        from('users');
        select('id');
        eq('id', user.Id);
        single();
      if (error instanceof Error ? error.message : String(error) | !user) {
      ...
      loggererror('Authentication error instanceof Error ? error.message : String(error) , undefined, error instanceof Error ? error.message : String(error);
  ...
  private async handle.Personality.Change(
    ...
    try {
      ...
      thisbroadcast.To.User(
        ...
        ws)} catch (error) {
      loggererror('Personality change error instanceof Error ? error.message : String(error) , undefined, error instanceof Error ? error.message : String(error);
  ...
  private async handle.Clothing.Update(
    ...
    try {
      ...
      thisbroadcast.To.User(
        ...
        ws)} catch (error) {
      loggererror('Clothing update error instanceof Error ? error.message : String(error) , undefined, error instanceof Error ? error.message : String(error);
  ...
  private async handle.State.Change(ws: Authenticated.Web.Socket, message: W.S.Message): Promise<void> {
    try {
      ...
      loggererror('State change error instanceof Error ? error.message : String(error) , undefined, error instanceof Error ? error.message : String(error);
  ...
  private async handle.Voice.Interaction(
    ...
    try {
      ...
      loggererror('Voice interaction error instanceof Error ? error.message : String(error) , undefined, error instanceof Error ? error.message : String(error);
  ...
  private handle.Error(ws: Authenticated.Web.Socket, client.Id: string, error instanceof Error ? error.message : String(error) Error): void {
    loggererror('Web.Socket.connection error instanceof Error ? error.message : String(error) , undefined, { error instanceof Error ? error.message : String(error)client.Id, user.Id: wsuser.Id }),
    thiscleanup(ws, client.Id)}/**
