...
export class Reranking.Pipeline {
  ...
  async search(
    ...
    try {
      ...
      this.loggererror('Pipeline search failed:', error instanceof Error ? error.message : String(error);
  ...
  async search.Knowledge.Entities(
    ...
    try {
      ...
      this.loggererror('Knowledge entity search failed:', error instanceof Error ? error.message : String(error);
      throw error instanceof Error ? error.message : String(error)}}/**
