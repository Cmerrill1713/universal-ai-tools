...
export class Enhanced.Logger {
  ...
  track.Error(error instanceof Error ? error.message : String(error) Error | string, context: Log.Context, metadata?: Record<string, any>): Error.Tracking {
...
export const logger = {
  error instanceof Error ? error.message : String(error) (message: string, context?: Log.Context, meta?: any) => enhanced.Loggererror(message: context, meta);
  ...
  track.Error: (error instanceof Error ? error.message : String(error) Error | string, context: Log.Context, metadata?: Record<string, any>) =>
    enhanced.Loggertrack.Error(error instanceof Error ? error.message : String(error) context, metadata);
