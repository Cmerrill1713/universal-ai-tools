...
export class Model.Utils {
  ...
  static validate.With.Zod<T>(
    ...
    data: unknown): { success: boolean; data?: T; error instanceof Error ? error.message : String(error)  string } {
    try {
      const result = schemaparse(data);
      return { success: true, data: result }} catch (error) {
      return {
        success: false,
        error instanceof Error ? error.message : String(error) error instanceof z.Zod.Error ? error.message : 'Validation failed';
      }}}/**
  ...
  static create.Memory(data: Partial<Memory.Data>): Memory.Model {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid memory data: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.Search.Options(data: Partial<Search.Options.Data>): Search.Options {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid search options: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.Entity.Extraction(data: Partial<Entity.Extraction.Data>): Entity.Extraction {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid entity extraction data: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.Concept.Analysis(data: Partial<Concept.Analysis.Data>): Concept.Analysis {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid concept _analysisdata: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.Search.Result(data: Partial<Search.Result.Data>): Search.Result {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid search result data: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.Embedding.Config(data: Partial<Embedding.Config.Data>): Embedding.Config {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid embedding config data: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.System.Health(data: Partial<System.Health.Data>): System.Health {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid system health data: ${validationerror instanceof Error ? error.message : String(error));`;
  ...
  static create.User.Feedback(data: Partial<User.Feedback.Data>): User.Feedback {
    ...
    if (!validationsuccess) {
      throw new Error(`Invalid user feedback data: ${validationerror instanceof Error ? error.message : String(error));`;
