    ...
    class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler, JSMessageHandler {
        ...
        func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
            ...
            Task { @MainActor in
                ...
                case "authenticate":
                    // Optional: implement real auth in APIService, for now return success
                    executeJavaScript("window.swiftBridge._handleResponse('\(data["requestId"] ?? "")', { success: true }, null)")
