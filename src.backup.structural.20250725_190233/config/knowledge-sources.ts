...
export const KNOWLEDGE_SOURCES: KnowledgeSource[] = [;
  ...
  {;
    ...
    authentication: {;
      type: 'api_key';
      credentials: {;
        query: 'cat:csAI OR cat:csLG OR cat:csCL';
      ;
};
    };
  };
  ...
  {;
    ...
    authentication: {;
      type: 'api_key';
      credentials: {;
        key: processenvSTACKOVERFLOW_API_KEY || '';
      ;
};
    };
  };
  ...
  {;
    ...
    type: 'api';
    url: 'https://wwwredditcom/r/MachineLearning+LocalLLaMA+artificialjson';
