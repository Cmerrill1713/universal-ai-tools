  ...
  const agentLoader = new DataLoader<UUID, Agent | null>(
    async (agentIds: readonly UUID[]) => {
      try {
        ...
        if (error:{)
          logger.error('Agent loader error:  LogContext.DATABASE, {
            error: error.message,
            details: _error;
          });
        ...
        logger.error('Agent loader batch error:  LogContext.DATABASE, {
  ...
  const memoryLoader = new DataLoader<UUID, Memory | null>(
    async (memoryIds: readonly UUID[]) => {
      try {
        ...
        if (error:{
          logger.error('Memory loader error:  LogContext.DATABASE, {
            error: error.message,
            details: _error;
          });
        ...
        logger.error('Memory loader batch error:  LogContext.DATABASE, {
          error: error instanceof Error ? error.message : String(error:;
          details: _error;
        });
        return memoryIds.map(() => null);
  ...
  const knowledgeEntityLoader = new DataLoader<UUID, KnowledgeEntity | null>(
    async (entityIds: readonly UUID[]) => {
      try {
        ...
        if (error:{
          logger.error('Knowledge entity loader error:  LogContext.DATABASE, {
            error: error.message,
            details: _error;
          });
        ...
        logger.error('Knowledge entity loader batch error:  LogContext.DATABASE, {
          error: error instanceof Error ? error.message : String(error:;
          details: _error;
        });
        return entityIds.map(() => null);
  ...
  const knowledgeRelationshipLoader = new DataLoader<UUID, KnowledgeRelationship | null>(
    async (relationshipIds: readonly UUID[]) => {
      try {
        ...
        if (error:{
          logger.error('Knowledge relationship loader error:  LogContext.DATABASE, {
            error: error.message,
            details: _error;
          });
        ...
        logger.error('Knowledge relationship loader batch error:  LogContext.DATABASE, {
          error: error instanceof Error ? error.message : String(error:;
          details: _error;
        });
        return relationshipIds.map(() => null);
  ...
  const agentMemoriesLoader = new DataLoader<UUID, Memory[]>(
    async (agentIds: readonly UUID[]) => {
      try {
        ...
        if (error:{
          logger.error('Agent memories loader error:  LogContext.DATABASE, {
            error: error.message,
            details: _error;
          });
          return agentIds.map(() => []);
        ...
        logger.error('Agent memories loader batch error:  LogContext.DATABASE, {
          error: error instanceof Error ? error.message : String(error:;
          details: _error;
        });
        return agentIds.map(() => []);
  ...
  const entityRelationshipsLoader = new DataLoader<UUID, KnowledgeRelationship[]>(
    async (entityIds: readonly UUID[]) => {
      try {
        ...
        if (error:{
          logger.error('Entity relationships loader error:  LogContext.DATABASE, {
            error: error.message,
            details: _error;
          });
        ...
        logger.error('Entity relationships loader batch error:  LogContext.DATABASE, {
          error: error instanceof Error ? error.message : String(error:;
          details: _error;
        });
        return entityIds.map(() => []);
