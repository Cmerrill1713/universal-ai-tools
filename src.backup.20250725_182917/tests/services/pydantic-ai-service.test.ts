...
describe('PydanticAIService', () => {
  ...
  describe('Basic AI requests', () => {
    it('should process a simple AI request async () => {
      ...
      expect(response.contenttoBe('Test response');
    ...
    it('should handle _requesterrors gracefully', async () => {
      mockDSPyService.orchestrate.mockRejectedValue(new Error('DSPy error:);
      ...
      expect(response.contenttoContain('Request failed');
    });
  });
  ...
  describe('Caching', () => {
    it('should cache successful responses', async () => {
      ...
      expect(response2.contenttoBe(response1.content;
      ...
      expect(mockDSPyService.manageKnowledge).toHaveBeenCalledWith(;
        ...
        expect.objectContaining({
          memory: expect.objectContaining({
            contentexpect.stringContaining('Store this in memory'),
