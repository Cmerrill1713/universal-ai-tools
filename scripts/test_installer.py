...
def test_installer():
    ...
    installer_path = Path(
        "/Users/christianmerrill/Desktop/universal-ai-tools/installer/Universal AI Tools Installer.pkg"
    )
    ...
    try:
        result = subprocess.run(
            ["pkgutil", "--check-signature", str(installer_path)], capture_output=True, text=True
        )
