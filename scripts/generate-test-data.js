...
const PERSONALITY_MOODS = ['sweet', 'playful', 'caring', 'energetic', 'calm', 'cheerful'];
...
class TestDataGenerator {
  ...
  generateAthenaInteraction() {
    return {
      ...
      interactionType:
        SWEET_ATHENA_INTERACTIONS[Math.floor(Math.random() * SWEET_ATHENA_INTERACTIONS.length)],
  ...
  async makeRequest(endpoint, data = null) {
    ...
    try {
      ...
      if (
        data &&
        (endpoint.includes('interact') || endpoint.includes('chat') || endpoint.includes('store'))
      ) {
      ...
      process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && console.log(
        `[${new Date().toISOString()}] ${response.status} ${endpoint} (${responseTime}ms)`
      );
      ...
      process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && console.error(
        `[${new Date().toISOString()}] ERROR ${endpoint} (${responseTime}ms): ${error.message}`
      );
  ...
  async finish() {
    ...
    Object.keys(this.results.endpoints).forEach((endpoint) => {
      ...
      const responseTimes = this.results.responseTimes.filter(
        (_, index) => index % ENDPOINTS.length === ENDPOINTS.indexOf(endpoint)
      );
