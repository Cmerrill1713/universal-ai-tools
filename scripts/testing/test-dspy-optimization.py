        ...
        try:
            async with websockets.connect(uri) as websocket:
                ...
                for scenario_name, scenario in TEST_SCENARIOS.items():
                    ...
                    baseline_results[scenario_name] = {"response": result, "time": response_time}
                ...
                for scenario_name, scenario in TEST_SCENARIOS.items():
                    ...
                    optimization_request = {
                        ...
                        "params": {"examples": scenario["examples"]},
                    }
                    ...
                    request = {
                        ...
                        "params": {
                            "userRequest": scenario["baseline_prompt"],
                            "context": {"optimization": "miprov2", "use_examples": True},
                        },
                    }
                    ...
                    optimized_results[scenario_name] = {"response": result, "time": response_time}
        ...
        try:
            async with websockets.connect(uri) as websocket:
                ...
                for problem in test_problems:
                    ...
                    improvement = (
                        ((cot_quality - no_cot_quality) / no_cot_quality * 100)
                        if no_cot_quality > 0
                        else 0
                    )
        ...
        try:
            async with websockets.connect(uri) as websocket:
                ...
                if metrics_result.get("success"):
                    ...
                    console.print(
                        f"Average improvement: {metrics.get('average_improvement', 0):.0%}"
                    )
        ...
        for scenario in baseline:
            if scenario in optimized:
                ...
                comparison_table.add_row(
                    ...
                    (
                        f"+{quality_improvement:.0f}%"
                        if quality_improvement > 0
                        else f"{quality_improvement:.0f}%"
                    ),
