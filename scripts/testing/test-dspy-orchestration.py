...
async def test_dspy_server():
    ...
    test_requests = [
        ...
        {
            "name": "Model Info",
            "request": {"requestId": "test-2", "method": "get_model_info", "params": {}},
        },
        {
            ...
            for test in test_requests:
                ...
                if result.get("success"):
                    ...
                    if method == "orchestrate":
                        ...
                        data = result.get("data", {})
                        key_info = (
                            f"Extracted: {len(str(data.get('entities', [])))} chars of knowledge"
                        )
                ...
                table.add_row(test["name"], test["request"]["method"], status, key_info)
...
async def test_api_integration():
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        test_data = {
            ...
            "context": {"project_type": "backend", "framework": "express"},
        }
