...
app.use((err, req, res, next) => {
  process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && console.error('Error:', err);
  res.status(500).json({
...
// Start server
app.listen(PORT, () => {
  process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && console.log(`
========================================
Minimal Test Server
========================================
Port: ${PORT}
