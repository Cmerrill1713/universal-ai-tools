...
TEST_TASKS = {
    "simple": ["What is 2+2?", "Hello, how are you?", "List three colors"],
    "moderate": [
    ...
    async def test_model(self, provider: str, model_name: str, task: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if provider == "Ollama" or provider == "Ollama Proxy":
                base_url = (
                    "http://localhost:11434" if provider == "Ollama" else "http://localhost:8080"
                )
    ...
    async def test_all_models(self):
        ...
        with Progress(
            ...
            for provider, model_name in models:
                ...
                model_results = {"provider": provider, "model": model_name, "tests": {}}
    ...
    async def test_endpoints(self):
        ...
        for method, endpoint, data, headers in endpoints:
            try:
                ...
                table.add_row(method, endpoint, "[red]❌ Error[/red]", "N/A")
