...
try:
    ...
    result = explainer(
        code="def mipro_optimize(module, examples): return optimizer.compile(module, trainset=examples)"
    )

    print("✅ DSPy Signature works!")
    ...
    result = reasoner(
        problem="How can MIPRO optimization improve DSPy agent orchestration performance?"
    )

    print("✅ Chain of Thought works!")
