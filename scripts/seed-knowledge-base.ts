...
const testKnowledgeEntries = [
  ...
  },
  {
    ...
    content: `Async/await error handling is done using try-catch blocks. When using async functions, wrap your await calls in try-catch to handle errors properly. Example: try { const result = await fetchData(); } catch (error) { process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && console.error('Error:', error); }`,
...
async function seedKnowledgeBase() {
  process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && process.env.NODE_ENV === 'development' && console.log('🌱 Seeding knowledge base with test data...\n');
