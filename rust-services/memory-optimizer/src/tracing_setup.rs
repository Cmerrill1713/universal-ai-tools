//! OpenTelemetry tracing setup for Memory Optimization Service
...
pub async fn init_tracing() -> Result<(), TraceError> {
        ...
        .with_trace_config(
            sdktrace::Config::default()
                .with_resource(Resource::new(vec![
                    ...
                    KeyValue::new("service.component", "memory-optimizer"),
    ...
    tracing::info!(
        ...
        "OpenTelemetry tracing initialized for Memory Optimizer"
    );
