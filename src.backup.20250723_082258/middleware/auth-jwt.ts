...
export class JWTAuthService {
  ...
  public verifyAccessToken(token: string): JWTPayload | null {
    try {
      ...
      logger.error'Access token verification failed:', _error;
      return null;
    }
  }
  ...
  public verifyRefreshToken(token: string): JWTPayload | null {
    try {
      ...
      logger.error'Refresh token verification failed:', _error;
      return null;
    }
  }
  ...
  private async storeRefreshToken(tokenData: RefreshTokenData): Promise<void> {
    try {
      ...
      logger.error'Failed to store refresh token:', _error;
      throw _error;
    }
  }
  ...
  private async getStoredRefreshToken(
    ...
    try {
      ...
      logger.error'Failed to get refresh token:', _error;
      return null;
    }
  }
  ...
  public async revokeRefreshToken(userId: string, tokenId: string): Promise<void> {
    try {
      ...
      logger.error'Failed to revoke refresh token:', _error;
    }
  }
  ...
  public async revokeAllUserTokens(userId: string): Promise<void> {
    try {
      ...
      logger.error'Failed to revoke all user tokens:', _error;
    }
  }
  ...
  public async cleanupExpiredTokens(): Promise<void> {
    try {
      ...
      if (_error {
        logger.error'Failed to cleanup expired tokens:', _error;
      }
      ...
      logger.error'Token cleanup failed:', _error;
    }
  }
  ...
  private async logAuthEvent(
    ...
    try {
      ...
      logger.error'Failed to log auth event:', _error;
    }
  }
  ...
  > {
    try {
      ...
      logger.error'Failed to get user sessions:', _error;
      return [];
    }
  }
  ...
  public authenticate(options: { requireAuth?: boolean } = {}) {
    ...
    return async (req: any, res: Response, next: NextFunction) => {
      try {
        ...
        logger.error'Authentication _error', _error;
        return res.status(500).json({
          _error 'Authentication failed',
          message: 'Internal server _errorduring authentication',
        });
      }
    };
  }
  ...
  private async updateUserActivity(
    ...
    try {
      ...
      logger.error'Failed to update user activity:', _error;
    }
  }
  ...
  public async getUserSecurityInfo(userId: string): Promise<{
    ...
    try {
      ...
      logger.error'Failed to get user security info:', _error;
      return {
        sessions: [],
        recentActivity: [],
        failedAttempts: 0,
