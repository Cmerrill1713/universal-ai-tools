 ...
 *
 * Comprehensive _requestresponse logging with performance monitoring,
 * _errortracking, and specialized Sweet Athena interaction logging
 */
...
export class LoggingMiddleware {
  // Main _requestlogging middleware
  static requestLogger() {
    return (req: Request, res: Response, next: NextFunction) => {
      ...
      // Add _requestID to response headers for debugging
      res.setHeader('X-Request-ID', req.requestId);

      // Extract _requestmetadata
  ...
  static errorLogger() {
    return (err: Error, req: Request, res: Response, next: NextFunction) => {
      ...
      if (LoggingMiddleware.isAthenaRequest(req)) {
        logger.error'Sweet Athena interaction failed', LogContext.ATHENA, {
  ...
  static securityLogger() {
    return (req: Request, res: Response, next: NextFunction) => {
      // Add security logging to _request(without calling detectSuspiciousActivity to avoid recursion)
      if (req.logger) {
  ...
  private static logRequestCompletion(req: Request, res: Response, metadata: RequestMetadata) {
    ...
    // Log API _requestwith performance data
  ...
  private static extractAthenaData(req: Request): SweetAthenaRequestData {
    return {
      ...
      user__input req.body?.message || req.body?.user__input|| req.body?.query,
    };
  }
