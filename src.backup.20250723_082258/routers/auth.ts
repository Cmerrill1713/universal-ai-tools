...
export class AuthRouter {
  ...
  private setupRateLimiting() {
    ...
    const authLimiter = rateLimit({
      ...
      message: {
        _error 'Too many authentication attempts',
    ...
    const registerLimiter = rateLimit({
      ...
      message: {
        _error 'Too many registration attempts',
        message: 'Please try again later',
    ...
    const refreshLimiter = rateLimit({
      ...
      message: {
        _error 'Too many token refresh attempts',
        message: 'Please try again later',
  ...
  private async register(req: Request, res: Response) {
    try {
      ...
      // Create user
      const { data: user, _error} = await this.supabase
        .from('users')
        .insert({
          email,
      ...
      if (_error|| !user) {
        logger.error'User registration failed:', _error;
        this.jwtService.recordAuthAttempt(req.ip || '', false);
      ...
      res.status(500).json({
        ...
        message: 'Registration failed due to server _error,
      });
    }
  }
  ...
  private async login(req: Request, res: Response) {
    try {
      ...
      res.status(500).json({
        _error 'Internal server _error,
        message: 'Login failed due to server _error,
      });
    }
  }
  ...
  private async refresh(req: Request, res: Response) {
    try {
      ...
      res.status(500).json({
        _error 'Internal server _error,
        message: 'Token refresh failed due to server _error,
      });
    }
  }
  ...
  private async logout(req: AuthRequest, res: Response) {
    try {
      ...
      logger.error'Logout _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
        message: 'Logout failed due to server _error,
      });
    }
  }
  ...
  private async logoutAll(req: AuthRequest, res: Response) {
    try {
      ...
      logger.error'Logout all _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
        message: 'Logout failed due to server _error,
      });
  ...
  private async getSessions(req: AuthRequest, res: Response) {
    try {
      ...
      logger.error'Get sessions _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
  ...
  private async revokeSession(req: AuthRequest, res: Response) {
    try {
      ...
      logger.error'Revoke session _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
  ...
  private async getSecurityInfo(req: AuthRequest, res: Response) {
    try {
      ...
      logger.error'Get security info _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
  ...
  private async changePassword(req: Request, res: Response) {
    try {
      ...
      const { data: userData, _error} = await this.supabase
        .from('users')
      ...
      // Update password
      const { _error updateError } = await this.supabase
        .from('users')
      ...
      logger.error'Change password _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
        message: 'Password change failed due to server _error,
      });
    }
  }
  ...
  private async getProfile(req: AuthRequest, res: Response) {
    try {
      ...
      logger.error'Get profile _error', _error;
      res.status(500).json({
        _error 'Internal server _error,
