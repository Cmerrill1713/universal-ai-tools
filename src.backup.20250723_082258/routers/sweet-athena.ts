...
export function SweetAthenaRouter() {
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        logger.error'Personality change _error', undefined, _error;
        res.status(500).json({
          success: false,
          _error 'Failed to change personality',
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        logger.error'Clothing update _error', undefined, _error;
        res.status(500).json({
          success: false,
          _error 'Failed to update clothing',
          details: (_erroras Error).message,
        });
      }
    }
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        logger.error'Chat interaction _error', undefined, _error;
        res.status(500).json({
          success: false,
          _error 'Failed to process chat interaction',
          details: (_erroras Error).message,
        });
      }
    }
  ...
  router.post('/voice', authenticate, upload.single('audio'), async (req: any, res: Response) => {
    try {
      ...
      logger.error'Voice interaction _error', undefined, _error;
      ...
      res.status(500).json({
        success: false,
        _error 'Failed to process voice interaction',
        details: (_erroras Error).message,
      });
    }
  });
  ...
  router.get('/status', authenticate, async (req: Request, res: Response) => {
    try {
      ...
      logger.error'Status check _error', undefined, _error;
      res.status(500).json({
        success: false,
        _error 'Failed to get avatar status',
        details: (_erroras Error).message,
      });
    }
  });
  ...
  router.put('/state', authenticate, validateInput, async (req: Request, res: Response) => {
    try {
      ...
      logger.error'State update _error', undefined, _error;
      res.status(500).json({
        success: false,
        _error 'Failed to update avatar state',
        details: (_erroras Error).message,
      });
    }
  });
  ...
  router.get('/preferences', authenticate, async (req: Request, res: Response) => {
    try {
      ...
      logger.error'Preferences retrieval _error', undefined, _error;
      res.status(500).json({
        success: false,
  ...
  router.put('/preferences', authenticate, validateInput, async (req: Request, res: Response) => {
    try {
      ...
      logger.error'Preferences update _error', undefined, _error;
      res.status(500).json({
        success: false,
  ...
  router.get('/personalities', async (req: Request, res: Response) => {
    try {
      ...
      logger.error'Personalities retrieval _error', undefined, _error;
      res.status(500).json({
        success: false,
        _error 'Failed to retrieve personality information',
      });
    }
  });
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        logger.error'Widget assistance _error', undefined, _error;
        res.status(500).json({
          success: false,
          _error 'Failed to provide widget assistance',
          details: (_erroras Error).message,
        });
      }
    }
