...
export interface Resolvers {
  Query: {
    ...
    searchMemories: Resolver<Memory[], any, { _input MemorySearchInput }>;
    ...
    searchKnowledgeEntities: Resolver<KnowledgeEntity[], any, { _input KnowledgeSearchInput }>;
    findConnectedEntities: Resolver<
      ConnectedEntity[],
      any,
      { startEntityId: UUID; maxDepth?: number; relationshipTypes?: string[] }
    >;
  ...
  Mutation: {
    createKnowledgeEntity: Resolver<KnowledgeEntity, any, { _input KnowledgeEntityInput }>;
    updateKnowledgeEntity: Resolver<
      KnowledgeEntity,
      any,
      { id: UUID; _input KnowledgeEntityInput }
    >;
    deleteKnowledgeEntity: Resolver<boolean, any, { id: UUID }>;
    createKnowledgeRelationship: Resolver<
      KnowledgeRelationship,
      any,
      { _input KnowledgeRelationshipInput }
    >;
    updateKnowledgeRelationship: Resolver<
      KnowledgeRelationship,
      any,
      { id: UUID; _input KnowledgeRelationshipInput }
    >;
    ...
    createMemory: Resolver<
      Memory,
      any,
      { _content string; agentId: string; importance: number; temporalContext?: JSON }
    >;
  };
