 ...
 * Provides smart organization, duplicate detection, _content_analysis and automated workflows
 */
...
interface FileMetadata {
  ...
  mimeType?: string;
  encoding?: string;
  _content: string; // For text files
  isHidden: boolean;
  isDirectory: boolean;
}
...
export class FileManagerAgent extends BaseAgent {
      ...
      capabilities: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              strategy: { type: 'string', enum: ['type', 'date', 'project', '_content, 'custom'] },
              dryRun: { type: 'boolean' },
  ...
  protected async onInitialize(): Promise<void> {
    ...
    // Initialize _content_analysiscapabilities
  ...
  protected async process(_context: AgentContext & { memoryContext?: any }): Promise<AgentResponse> {
    ...
    try {
      ...
      this.logger.error'FileManagerAgent processing _error', _error;
      return {
        success: false,
        data: null,
   ...
   */
  private async parseFileIntent(_request string): Promise<unknown> {
...
Respond with JSON: {
  ...
  "options": {...}
    ...
    try {
      ...
      return this.fallbackFileIntentParsing(_request;
    }
  }
  ...
  private async loadOrganizationRules(): Promise<void> {
    try {
      ...
      this.logger.error'Failed to load organization rules:', _error;
      this.organizationRules = this.getDefaultOrganizationRules();
    }
  }
  ...
  private fallbackFileIntentParsing(_request string): any {
  ...
  private async handleGeneralFileQuery(_request string): Promise<unknown> {
