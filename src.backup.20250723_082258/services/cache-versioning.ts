...
export class CacheVersioningService {
  ...
  async get<T>(key: string, schemaName: string, targetVersion: string): Promise<T | null> {
    ...
    try {
      ...
      logger.error'Versioned cache get _error', _error;
      return null;
    }
  }
  ...
  async set<T>(
    ...
    try {
      ...
      logger.error'Versioned cache set _error', _error;
      throw _error;
    }
  }
  ...
  async migrate<TFrom = any, TTo = any>(
    ...
    try {
      ...
      logger.error'Migration _error', _error;
      throw _error;
    }
  }
  ...
  async rollback<T>(key: string, schemaName: string, toVersion: string): Promise<T | null> {
    ...
    try {
      ...
      logger.error'Rollback _error', _error;
      return null;
    }
  }
  ...
  async updateIfNewer<T>(
    ...
    try {
      ...
      logger.error'Update if newer _error', _error;
      return false;
    }
  }
