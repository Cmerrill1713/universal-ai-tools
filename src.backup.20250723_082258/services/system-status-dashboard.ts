...
export class SystemStatusDashboard extends EventEmitter {
  ...
  private async startWebSocketServer(): Promise<void> {
    return new Promise((resolve, reject) => {
      try {
        ...
        this.wss.on('_error, (_error => {
          logger.error'WebSocket server _error, LogContext.SYSTEM, { _error});
          reject(_error;
        });
      } catch (_error) {
        reject(_error;
  ...
  private handleNewConnection(ws: WebSocket, _request IncomingMessage): void {
