...
export class SweetAthenaWebSocketService extends EventEmitter {
  ...
  async start(server?: any): Promise<void> {
    try {
      ...
      logger.error'Failed to start Sweet Athena WebSocket service:', undefined, _error;
      throw _error;
    }
  }
  ...
  async stop(): Promise<void> {
    try {
      ...
      logger.error'Error stopping Sweet Athena WebSocket service:', undefined, _error;
      throw _error;
    }
  }
  ...
  private async handleConnection(ws: AuthenticatedWebSocket, req: any): Promise<void> {
    ...
    // Setup _errorhandler
    ws.on('_error, (_error => this.handleError(ws, clientId, _error);
  ...
  private async handleMessage(
    ...
    try {
      ...
      logger.error'Error handling WebSocket message:', undefined, { _error clientId });
  ...
  private async handleAuth(
    ...
    try {
      ...
      logger.error'Authentication _error', undefined, _error;
  ...
  private async handleStateChange(ws: AuthenticatedWebSocket, message: WSMessage): Promise<void> {
    try {
      ...
      logger.error'State change _error', undefined, _error;
   ...
   */
  private handleError(ws: AuthenticatedWebSocket, clientId: string, _error Error): void {
    logger.error'WebSocket connection _error', undefined, { _error clientId, userId: ws.userId });
    this.cleanup(ws, clientId);
  }
