...
export class RerankingEvaluationService {
  ...
  async evaluateReranking(
    ...
    try {
      ...
      this.logger.error'Reranking evaluation failed:', _error;
      throw _error;
    }
  }
  ...
  async runABTest(
    ...
    for (const query of testQueries) {
      try {
        ...
        this.logger.warn(`A/B test failed for query "${query}":`, _error;
      }
    }
  ...
  async generateEvaluationDataset(
    ...
    try {
      ...
      const { data: searchHistory, _error} = await this.supabase
      ...
      this.logger.error'Failed to generate evaluation dataset:', _error;
      throw _error;
    }
  }
