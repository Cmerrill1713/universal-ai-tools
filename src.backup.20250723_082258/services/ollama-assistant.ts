...
export class OllamaAssistant {
  ...
  private async initializeModel() {
    try {
      ...
      logger.error'Failed to initialize Ollama model:', _error;
...
Respond with a JSON object containing:
{
  ...
  "estimated_complexity": "low|medium|high"
      ...
      logger.error'Ollama tool suggestion failed:', _error;
...
Respond with JSON: {"intent": "...", "domain": "...", "complexity": "...", "actionType": "..."}`;
      ...
      logger.error'Request _analysisfailed:', _error;
      return {
        intent: 'unknown',
        domain: 'general',
        complexity: 'medium',
  ...
  private async getRelevantContext(_request string): Promise<Context> {
    try {
      ...
      logger.error'Context retrieval failed:', _error;
  ...
  private async storeInteraction(_request string, response: any): Promise<void> {
    try {
      ...
      logger.error'Failed to store interaction:', _error;
    }
  }
...
Provide clean, production-ready code with comments.`;
    ...
    try {
      ...
      logger.error'Ollama code generation failed:', _error;
      throw _error;
    }
  }
...
Respond with specific file paths and code locations.`;
    ...
    try {
      ...
      logger.error'Ollama _analysisfailed:', _error;
      throw _error;
    }
  }
...
The implementation should be self-contained and handle errors.`;
    ...
    try {
      ...
      logger.error'Tool creation failed:', _error;
      throw _error;
    }
  }
...
Format as markdown with code examples.`;
    ...
    try {
      ...
      logger.error'Documentation generation failed:', _error;
      throw _error;
    }
  }
...
Respond with a JSON object containing the routing decision.`;
    ...
    try {
      ...
      logger.error'Request routing failed:', _error;
      return null;
    }
  }
}
