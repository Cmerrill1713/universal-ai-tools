...
export class PerformanceMonitor extends EventEmitter {
  ...
  async measureAgent(agent: BrowserAgent): Promise<PerformanceReport> {
    ...
    try {
      ...
      logger.error`Performance measurement failed for agent ${agent.id}:`, _error;
      metrics.errors.push(_errorinstanceof Error ? _errormessage : String(_error);
  ...
  private async collectWebVitals(agent: BrowserAgent, metrics: PerformanceMetrics): Promise<void> {
    try {
      ...
      logger.error'Failed to collect Web Vitals:', _error;
      metrics.errors.push(
        `Web Vitals collection failed: ${_errorinstanceof Error ? _errormessage : String(_error}`
      );
    }
  }
  ...
  private async collectMemoryUsage(
    ...
    try {
      ...
      logger.error'Failed to collect memory usage:', _error;
      metrics.errors.push(
        `Memory usage collection failed: ${_errorinstanceof Error ? _errormessage : String(_error}`
      );
    }
  }
  ...
  private async collectNetworkMetrics(
    ...
    try {
      ...
      logger.error'Failed to collect network metrics:', _error;
      metrics.errors.push(
        `Network metrics collection failed: ${_errorinstanceof Error ? _errormessage : String(_error}`
      );
    }
  }
  ...
  private async collectSystemMetrics(): Promise<void> {
    try {
      ...
      logger.error'Failed to collect system metrics:', _error;
    }
  }
  ...
  async runChecks(): Promise<unknown> {
    ...
    try {
      ...
      logger.error'Performance checks failed:', _error;
      return {
        duration: Date.now() - startTime,
