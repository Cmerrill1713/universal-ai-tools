...
export class WebSocketPerformanceTester extends EventEmitter {
  ...
  public async runWebSocketPerformanceTest(options: {
    ...
    try {
      ...
      logger.error'WebSocket performance test failed:', _error;
      ...
      try {
        ...
        this.server.on('connection', (socket) => {
          ...
          socket.on('_error, (_error => {
            logger.warn('Socket _error', _error;
          });
        });
  ...
  private async createTestConnection(connectionId: number, options: any): Promise<void> {
    ...
    try {
      ...
      const connectionPromise = new Promise<void>((resolve, reject) => {
        ...
        client.on('connect__error, (_error => {
          clearTimeout(timeout);
          this.metrics.push({
      ...
      logger.warn(`Failed to create connection ${connectionId}:`, _error;
    }
  }
