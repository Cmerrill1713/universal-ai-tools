...
from .trade import TradeType, TradeSide
...
class Order:
    ...
    def filled_value(self) -> Decimal:
        ...
        return self.filled_amount * self.avg_fill_price if self.avg_fill_price else Decimal('0')
    ...
    def add_fill(self, amount: Decimal, price: Decimal, fee: Decimal = None, 
        ...
        if self.filled_amount > 0:
            self.avg_fill_price = (old_filled_value + new_filled_value) / self.filled_amount
