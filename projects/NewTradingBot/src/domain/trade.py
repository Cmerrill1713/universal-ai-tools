...
class Trade:
    ...
    def update_fill(self, filled_amount: Decimal, filled_price: Decimal, fee: Decimal = None) -> None:
        """
        ...
        if self.filled_amount > 0:
            total_filled_value = (self.filled_price * (self.filled_amount - filled_amount)) + (filled_price * filled_amount)
    ...
    def __repr__(self) -> str:
        ...
        return (f"Trade(id='{self.id}', symbol='{self.symbol}', "
                f"type={self.trade_type.value}, side={self.side.value}, "
