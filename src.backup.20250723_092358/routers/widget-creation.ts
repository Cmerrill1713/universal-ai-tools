...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error('logger.error('Widget creation error', error);
      res.status(500).json({
        success: false,
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error('logger.error('Preview generation error', error);
      res.status(500).json({
        success: false,
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error('logger.error('Export error', error);
      res.status(500).json({
        success: false,
        error: 'Failed to export widget',
        details: (_erroras Error).message,
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error('logger.error('Get widget error', error);
      res.status(500).json({
        success: false,
...
router.get('/', authenticate, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('logger.error('List widgets error', error);
    res.status(500).json({
      success: false,
...
router.delete(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error('logger.error('Delete widget error', error);
      res.status(500).json({
        success: false,
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error('logger.error('Update widget error', error);
      res.status(500).json({
        success: false,
