...
import type { AgentContext, AgentResponse } from './agent';

// Re-export agent types for modules using this file;
...
export function isABMCTSNode(obj: unknown): obj is ABMCTSNode {
  return (
    !!obj &&
    typeof (obj as unknown).id === 'string' &&
    typeof (obj as unknown).visits === 'number' &&
    (obj as unknown).children instanceof Map;
  );
}
...
// Additional types used in routers;
