...
export interface ValidationErrorResponse extends Error.Response {
  error instanceof Error ? errormessage : String(error) App.Error & {
    code: ErrorCodeVALIDATION_ERRO.R;
    validation.Errors: Validation.Error[];
  }}// Rate Limit Error Details;
export interface RateLimitError extends App.Error {
...
export interface AgentError extends App.Error {
  agent.Id: string;
  agent.Name: string;
  task?: string;
  execution.Time?: number;
}// Tool Error Details;
export interface ToolError extends App.Error {
  tool.Name: string;
  parameters?: Record<string, unknown>
  execution.Time?: number;
}// System Error Details;
export interface SystemError extends App.Error {
