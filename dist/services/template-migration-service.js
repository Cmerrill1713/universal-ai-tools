...
export class TemplateMigrationService {
    ...
    async migrateEnterpriseTemplates() {
        const result = {
            success: true,
            migratedFiles: 0,
            spaceSaved: 0,
    ...
    async archiveLargeAssets(options = {}) {
        const result = {
            success: true,
            migratedFiles: 0,
            spaceSaved: 0,
    ...
    async migrateDirectory(dirPath, bucket, result) {
    ...
    async migrateFile(filePath, bucket, storagePath) {
    ...
    async archiveFile(filePath, bucket, storagePath) {
        const content = await fs.readFile(filePath);
    ...
    async archiveScreenshots(result, options) {
    ...
    async archiveOldLogs(result, options) {
    ...
    async archiveBackupDirectories(result, options) {
    ...
    async cleanupPattern(pattern, result) {
