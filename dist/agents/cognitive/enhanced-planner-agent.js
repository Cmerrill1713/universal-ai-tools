    ...
    calculateConfidence(llmResponse, context) {
        ...
        try {
            ...
            if (parsed.plan && parsed.plan.phases && Array.isArray(parsed.plan.phases)) {
                confidence += 0.1;
                const hasWellStructuredTasks = parsed.plan.phases.some((phase) => phase.tasks && Array.isArray(phase.tasks) && phase.tasks.length > 0);
...
//# sourceMappingURL=enhanced-planner-agent.js.map