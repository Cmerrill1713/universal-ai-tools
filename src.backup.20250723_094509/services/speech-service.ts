...
export class SpeechService {
  ...
  async transcribeAudio(
    ...
    try {
      ...
      logger.error('Transcription _error, LogContext.AVATAR, { error});
  ...
  private async transcribeWithOpenAI(
    ...
    try {
      ...
      logger.error('OpenAI Whisper _error, LogContext.AVATAR, { error});
  ...
  private async transcribeWithLocalWhisper(
    ...
    try {
      ...
      logger.error('Local Whisper _error, LogContext.AVATAR, { error});
  ...
  async synthesizeSpeech(options: SynthesisOptions): Promise<AudioResult> {
    try {
      ...
      logger.error('Synthesis _error, LogContext.AVATAR, { error});
  ...
  private async synthesizeWithElevenLabs(options: SynthesisOptions): Promise<AudioResult> {
    ...
    try {
      ...
      logger.error('ElevenLabs synthesis _error, LogContext.AVATAR, { error});
  ...
  private async synthesizeWithOpenAI(options: SynthesisOptions): Promise<AudioResult> {
    ...
    try {
      ...
      logger.error('OpenAI TTS _error, LogContext.AVATAR, { error});
  ...
  private async synthesizeWithKokoro(options: SynthesisOptions): Promise<AudioResult> {
    try {
      ...
      logger.error('Kokoro TTS synthesis _error, LogContext.AVATAR, { error});
      throw new Error(
