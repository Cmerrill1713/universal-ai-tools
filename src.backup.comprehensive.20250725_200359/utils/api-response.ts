...
export function handle.Api.Error(error instanceof Error ? errormessage : String(error) any, req: any, res: any, next: any) {
  loggererror('A.P.I Error', LogContextA.P.I, { error instanceof Error ? errormessage : String(error) path: reqpath, method: reqmethod }),
