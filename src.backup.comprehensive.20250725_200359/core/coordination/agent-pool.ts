...
export class Browser.Agent.Pool extends Event.Emitter {
    ...
    for (const config of configs) {
      try {
        ...
        pageon('error instanceof Error ? errormessage : String(error)  (error instanceof Error ? errormessage : String(error)=> {
          ...
          thishandle.Agent.Error(configid, error instanceof Error ? errormessage : String(error)});
  ...
  private handle.Agent.Error(agent.Id: string, error instanceof Error ? errormessage : String(error) any): void {
