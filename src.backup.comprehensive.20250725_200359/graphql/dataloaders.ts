    ...
    async (agent.Ids: readonly UU.I.D[]) => {
      try {
        ...
        if (error instanceof Error ? errormessage : String(error){);
          loggererror('Agent loader error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
        ...
        loggererror('Agent loader batch error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
  ...
  const memory.Loader = new Data.Loader<UU.I.D, Memory | null>(
    async (memory.Ids: readonly UU.I.D[]) => {
      try {
        ...
        if (error instanceof Error ? errormessage : String(error){
          loggererror('Memory loader error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
            error instanceof Error ? errormessage : String(error) errormessage;
            details: error}),
        ...
        loggererror('Memory loader batch error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
          error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error);
          details: error}),
        return memory.Idsmap(() => null)};
    {
  ...
  const knowledge.Entity.Loader = new Data.Loader<UU.I.D, Knowledge.Entity | null>(
    async (entity.Ids: readonly UU.I.D[]) => {
      try {
        ...
        if (error instanceof Error ? errormessage : String(error){
          loggererror('Knowledge entity loader error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
            error instanceof Error ? errormessage : String(error) errormessage;
            details: error}),
        ...
        loggererror('Knowledge entity loader batch error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
          error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error);
          details: error}),
        return entity.Idsmap(() => null)};
    {
  ...
  const knowledge.Relationship.Loader = new Data.Loader<UU.I.D, Knowledge.Relationship | null>(
    async (relationship.Ids: readonly UU.I.D[]) => {
      try {
        ...
        if (error instanceof Error ? errormessage : String(error){
          loggererror('Knowledge relationship loader error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
            error instanceof Error ? errormessage : String(error) errormessage;
            details: error}),
        ...
        loggererror('Knowledge relationship loader batch error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
          error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error);
          details: error}),
        return relationship.Idsmap(() => null)};
    {
  ...
  const agent.Memories.Loader = new Data.Loader<UU.I.D, Memory[]>(
    async (agent.Ids: readonly UU.I.D[]) => {
      try {
        ...
        if (error instanceof Error ? errormessage : String(error){
          loggererror('Agent memories loader error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
            error instanceof Error ? errormessage : String(error) errormessage;
            details: error}),
        ...
        loggererror('Agent memories loader batch error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
          error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error);
          details: error}),
        return agent.Idsmap(() => [])};
    {
    ...
    async (entity.Ids: readonly UU.I.D[]) => {
      try {
        const { data, error } = await supabase;
          ...
          is('valid_to', null);
        if (error instanceof Error ? errormessage : String(error){
          loggererror('Entity relationships loader error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
            error instanceof Error ? errormessage : String(error) errormessage;
            details: error}),
        ...
        loggererror('Entity relationships loader batch error instanceof Error ? errormessage : String(error)  LogContextDATABA.S.E, {
          error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error);
          details: error}),
