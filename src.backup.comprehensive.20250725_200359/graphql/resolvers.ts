  ...
  Query: {
    ...
    find.Connected.Entities: async (
      ...
      try {
        ...
        if (error instanceof Error ? errormessage : String(error) throw error instanceof Error ? errormessage : String(error)// Transform the data to match the Graph.Q.L schema;
