...
export class Production.Cache.Manager {
  ...
  async get<T = any>(key: string): Promise<T | null> {
    try {
      ...
      loggererror('Cache get error instanceof Error ? errormessage : String(error)  LogContextCAC.H.E, {';
        key;
  ...
  async set<T = any>(key: string, value: T, options: Cache.Options = {}): Promise<boolean> {
    try {
      ...
      loggererror('Cache set error instanceof Error ? errormessage : String(error)  LogContextCAC.H.E, {
        key;
        error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error)});
      return false}}/**
   * Delete single key*/
  async delete(key: string): Promise<boolean> {
    try {
      ...
      loggererror('Cache delete error instanceof Error ? errormessage : String(error)  LogContextCAC.H.E, {
        key;
        error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error)});
      return false}}/**
   * Invalidate by tags*/
  async invalidate.By.Tags(tags: string[]): Promise<number> {
    try {
      ...
      loggererror('Cache invalidate by tags error instanceof Error ? errormessage : String(error)  LogContextCAC.H.E, {
        tags;
        error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error)});
      return 0}}/**
   * Clear all cache*/
  async clear(): Promise<boolean> {
    try {
      ...
      return true} catch (error) {
      loggererror('Cache clear error instanceof Error ? errormessage : String(error)  LogContextCAC.H.E, {
        error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error)});
      return false}}/**
  ...
  async get.Stats(): Promise<Cache.Stats> {
    try {
      ...
      loggererror('Cache stats error instanceof Error ? errormessage : String(error)  LogContextCAC.H.E, {
        error instanceof Error ? errormessage : String(error) error instanceof Error ? errormessage : String(error instanceof Error ? errormessage : String(error)});
      return { .thisstats }}}/**
