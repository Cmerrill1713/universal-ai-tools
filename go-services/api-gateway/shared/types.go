...
const (
	...
	// Additional service types for our running services
	ServiceTypeAPI      ServiceType = "api_gateway"
	ServiceTypeAuth     ServiceType = "auth_service"
	ServiceTypeChat     ServiceType = "chat_service"
	ServiceTypeMemory   ServiceType = "memory_service"
	ServiceTypeWebSocket ServiceType = "websocket_hub"
	ServiceTypeMetrics  ServiceType = "metrics_aggregator"
)
