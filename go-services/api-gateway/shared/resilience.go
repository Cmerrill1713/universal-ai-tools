...
func (rm *ResilienceManager) GetMetrics() ResilienceMetrics {
	...
	return ResilienceMetrics{
		TotalRequests:       rm.metrics.TotalRequests,
		SuccessfulRequests:  rm.metrics.SuccessfulRequests,
		FailedRequests:      rm.metrics.FailedRequests,
		RejectedRequests:    rm.metrics.RejectedRequests,
		TimeoutRequests:     rm.metrics.TimeoutRequests,
		CircuitBreakerTrips: rm.metrics.CircuitBreakerTrips,
		RetryAttempts:       rm.metrics.RetryAttempts,
		BulkheadRejections:  rm.metrics.BulkheadRejections,
	}
}
