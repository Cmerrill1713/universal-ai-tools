...
func main() {
	...
	aggregator.RegisterService("ml-go", "go", "http://localhost:8086", map[string]string{"framework": "go"})
	aggregator.RegisterService("ml-rust", "rust", "http://localhost:8087", map[string]string{"framework": "rust"})
	aggregator.RegisterService("node-backend", "node", "http://localhost:9999", map[string]string{"framework": "node"})
