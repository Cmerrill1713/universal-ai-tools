...
export interface AgentEvent extends WebSocketEvent {
  type: 'agent_started' | 'agent_completed' | 'agent_error' | 'agent_progress';
  data: {
    agentId: string;
    agentName: string;
    task?: string;
...
export interface OrchestrationEvent extends WebSocketEvent {
  type: 'orchestration_started' | 'orchestration_step' | 'orchestration_completed' | 'orchestration_error';
  data: {
...
export interface SpeechEvent extends WebSocketEvent {
  type: 'speech_started' | 'speech_completed' | 'speech_error';
  data: {
    text: string;
    voice?: string;
    audioUrl?: string;
