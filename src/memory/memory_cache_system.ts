...
export class MemoryCacheSystem {
  ...
  getCacheStats(): {
    ...
    const totalHits = hotStats.hits + warmStats.hits + searchStats.hits + embeddingStats.hits + coldStats.hits;
    const totalMisses = hotStats.misses + warmStats.misses + searchStats.misses + embeddingStats.misses + coldStats.misses;
