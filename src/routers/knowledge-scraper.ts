/**
 * Knowledge Scraper API Router
 * Endpoints for managing knowledge base scraping and search
 */
...
/**
 * @route POST /api/v1/knowledge/scrape
 * @desc Start scraping knowledge from configured sources
 */
...
/**
 * @route GET /api/v1/knowledge/status
 * @desc Get knowledge scraping status and statistics
 */
...
/**
 * @route GET /api/v1/knowledge/sources
 * @desc Get available knowledge sources
 */
 ...
 * @desc Get available knowledge categories
 */
...
/**
 * @route POST /api/v1/knowledge/sources/:sourceName/toggle
 * @desc Enable or disable a knowledge source
 */
router.post('/sources/:sourceName/toggle', async (req: Request, res: Response) => {
  try {
    const { sourceName } = req.params;
    const { enabled } = req.body;

    // This would update the source configuration in the database
...
/**
 * @route GET /api/v1/knowledge/reranking/stats
 * @desc Get reranking performance statistics
 */
router.get('/reranking/stats', async (req: Request, res: Response, next: NextFunction) => {
  try {
