/**
 * Proactive Task Manager Router
 * Exposes advanced task scheduling and management features
 */
...
// GET /api/v1/proactive-tasks/status
...
// PUT /api/v1/proactive-tasks/:taskId
...
// DELETE /api/v1/proactive-tasks/:taskId
...
// POST /api/v1/proactive-tasks/:taskId/execute
...
// GET /api/v1/proactive-tasks/suggestions
