  ...
  Query: {
    ...
    agent: async (parent, { id }, { supabase, loaders }) => {
      try {
        ...
        logger.error('Error fetching agent', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return null;
      }
    },
    ...
    agents: async (parent, { ids, status, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching agents', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    agentCoordination: async (parent, { agentIds }, { supabase }) => {
      try {
        const { data, error } = await supabase.rpc('get_agent_coordination_data', {
          agent_ids: agentIds
        });
        ...
        logger.error('Error fetching agent coordination data', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    memory: async (parent, { id }, { loaders }) => {
      try {
        ...
        logger.error('Error fetching memory', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return null;
      }
    },
    ...
    searchMemories: async (parent, { input }, { supabase }) => {
      try {
        const { data, error } = await supabase.rpc('search_memories_with_context', {
          query_text: input.query,
          agent_id: input.agentId,
          importance_threshold: input.importanceThreshold || 0.3,
          limit_count: input.limit || 10,
          temporal_weight: input.temporalWeight || 0.3
        });

        if (error) throw error;
        return data || [];
      } catch (error) {
        logger.error('Error searching memories', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    knowledgeEntity: async (parent, { id }, { loaders }) => {
      try {
        ...
        logger.error('Error fetching knowledge entity', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return null;
      }
    },
    ...
    knowledgeEntities: async (parent, { entityType, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching knowledge entities', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    searchKnowledgeEntities: async (parent, { input }, { supabase }) => {
      try {
        const { data, error } = await supabase.rpc('search_knowledge_entities', {
        ...
        logger.error('Error searching knowledge entities', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },

    findConnectedEntities: async (parent, { startEntityId, maxDepth = 3, relationshipTypes }, { supabase }) => {
      try {
        ...
        logger.error('Error finding connected entities', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    knowledgeSnapshotAtTime: async (parent, { timestamp }, { supabase }) => {
      try {
        const { data, error } = await supabase.rpc('knowledge_snapshot_at_time', {
        ...
        logger.error('Error fetching knowledge snapshot', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },
    ...
    currentKnowledgeSnapshot: async (parent, args, { supabase }) => {
      ...
      return resolvers.Query.knowledgeSnapshotAtTime(parent, { timestamp: now }, { supabase } as GraphQLContext, {});
    },

    knowledgeEvolution: async (parent, { startTime, endTime }, { supabase }) => {
      try {
        const { data, error } = await supabase.rpc('knowledge_evolution', {
        ...
        logger.error('Error fetching knowledge evolution', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },
    ...
    systemHealth: async (parent, args, { supabase }) => {
      try {
        const [agentCount, memoryCount, knowledgeEntityCount] = await Promise.all([
          ...
          supabase.from('knowledge_entities').select('id', { count: 'exact', head: true }).is('valid_to', null)
        ]);
        ...
        logger.error('Error fetching system health', LogContext.SYSTEM, { error: error instanceof Error ? error.message : String(error), details: error });
        return {
          status: 'error',
          agentCount: 0,
          memoryCount: 0,
  ...
  Mutation: {
    ...
    createKnowledgeEntity: async (parent, { input }, { supabase, user }) => {
      try {
        ...
        logger.error('Error creating knowledge entity', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },
    ...
    updateKnowledgeEntity: async (parent, { id, input }, { supabase, user }) => {
      try {
        ...
        logger.error('Error updating knowledge entity', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },
    ...
    deleteKnowledgeEntity: async (parent, { id }, { supabase, user }) => {
      try {
        ...
        logger.error('Error deleting knowledge entity', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return false;
      }
    },
    ...
    createKnowledgeRelationship: async (parent, { input }, { supabase, user }) => {
      try {
        ...
        logger.error('Error creating knowledge relationship', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },
    ...
    updateKnowledgeRelationship: async (parent, { id, input }, { supabase, user }) => {
      try {
        ...
        logger.error('Error updating knowledge relationship', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },
    ...
    deleteKnowledgeRelationship: async (parent, { id }, { supabase, user }) => {
      try {
        ...
        logger.error('Error deleting knowledge relationship', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return false;
      }
    },
    ...
    updateAgentStatus: async (parent, { id, status }, { supabase }) => {
      try {
        ...
        logger.error('Error updating agent status', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    },

    // Memory mutations
    createMemory: async (parent, { content, agentId, importance, temporalContext }, { supabase }) => {
      try {
        ...
        logger.error('Error creating memory', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        throw error;
      }
    }
  },
  ...
  Agent: {
    ...
    performance: async (parent, args, { supabase }) => {
      try {
        ...
        logger.error('Error fetching agent performance', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return {
          memoryCount: 0,
    ...
    knowledgeEntities: async (parent, args, { supabase }) => {
      try {
        ...
        logger.error('Error fetching agent knowledge entities', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    }
  },
    ...
    connections: async (parent, args, { supabase }) => {
      try {
        ...
        return (data || []).map((conn: any) => ({
          ...
          targetContent: conn.target_memory?.content || ''
        }));
      } catch (error) {
        logger.error('Error fetching memory connections', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
  ...
  KnowledgeEntity: {
    outgoingRelationships: async (parent, { types, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching outgoing relationships', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    incomingRelationships: async (parent, { types, limit = 10 }, { supabase }) => {
      try {
        ...
        logger.error('Error fetching incoming relationships', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return [];
      }
    },
    ...
    causalEvent: async (parent, args, { supabase }) => {
      if (parent.causalEventId) {
        try {
          ...
          logger.error('Error fetching causal event', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
          return null;
        }
      }
      return null;
