...
const resolvers = {
  Query: {
    ...
    memories: async (_: any, _args: any, _context: any) => {
      // TODO: Implement memory retrieval with MCP integration
      return [];
    },
    
    memory: async (_: any, { id: _id }: { id: string }) => {
    ...
    users: async (_: any, { role: _role }: { role?: string }) => {
  ...
  Mutation: {
    login: async (_: any, { email: _email, password: _password }: { email: string; password: string }) => {
    ...
    refreshToken: async (_: any, __: any, _context: any) => {
      // TODO: Implement token refresh
      throw new Error('Token refresh not yet implemented');
    },
    
    executeAgent: async (_: any, args: any, _context: any) => {
      ...
      try {
        ...
        const result = await agent.execute({
          ...
          userId: _context.user?.id || 'anonymous',
    ...
    deleteMemory: async (_: any, { id: _id }: { id: string }) => {
      // TODO: Implement memory deletion
      return true;
    },
    
    updatePreferences: async (_: any, { preferences: _preferences }: any, _context: any) => {
