  ...
  const agentLoader = new DataLoader<UUID, Agent | null>(
    async (agentIds: readonly UUID[]) => {
      try {
        ...
        if (error) {
          logger.error('Agent loader error', LogContext.DATABASE, { error: error.message, details: error });
        ...
        logger.error('Agent loader batch error', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return agentIds.map(() => null);
      }
    },
    {
  ...
  const memoryLoader = new DataLoader<UUID, Memory | null>(
    async (memoryIds: readonly UUID[]) => {
      try {
        ...
        if (error) {
          logger.error('Memory loader error', LogContext.DATABASE, { error: error.message, details: error });
        ...
        logger.error('Memory loader batch error', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return memoryIds.map(() => null);
      }
    },
    {
  ...
  const knowledgeEntityLoader = new DataLoader<UUID, KnowledgeEntity | null>(
    async (entityIds: readonly UUID[]) => {
      try {
        ...
        if (error) {
          logger.error('Knowledge entity loader error', LogContext.DATABASE, { error: error.message, details: error });
        ...
        logger.error('Knowledge entity loader batch error', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return entityIds.map(() => null);
      }
    },
    {
  ...
  const knowledgeRelationshipLoader = new DataLoader<UUID, KnowledgeRelationship | null>(
    async (relationshipIds: readonly UUID[]) => {
      try {
        ...
        if (error) {
          logger.error('Knowledge relationship loader error', LogContext.DATABASE, { error: error.message, details: error });
        ...
        logger.error('Knowledge relationship loader batch error', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return relationshipIds.map(() => null);
      }
    },
    {
  ...
  const agentMemoriesLoader = new DataLoader<UUID, Memory[]>(
    async (agentIds: readonly UUID[]) => {
      try {
        ...
        if (error) {
          logger.error('Agent memories loader error', LogContext.DATABASE, { error: error.message, details: error });
          return agentIds.map(() => []);
        }
        ...
        logger.error('Agent memories loader batch error', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return agentIds.map(() => []);
      }
    },
    {
  ...
  const entityRelationshipsLoader = new DataLoader<UUID, KnowledgeRelationship[]>(
    async (entityIds: readonly UUID[]) => {
      try {
        ...
        if (error) {
          logger.error('Entity relationships loader error', LogContext.DATABASE, { error: error.message, details: error });
        ...
        logger.error('Entity relationships loader batch error', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
        return entityIds.map(() => []);
      }
    },
    {
 ...
 */
export function primeDataLoaders(loaders: DataLoaders, data: {
  agents?: Agent[];
  memories?: Memory[];
  ...
  try {
    ...
    logger.error('Error priming DataLoaders', LogContext.DATABASE, { error: error instanceof Error ? error.message : String(error), details: error });
  }
}