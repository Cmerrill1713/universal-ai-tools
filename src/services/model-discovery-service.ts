...
export class ModelDiscoveryService {
  ...
  async shutdown(): Promise<void> {
    log.info('Shutting down Model Discovery Service...', LogContext.AI);
    ...
    try {
      ...
      log.info('Model Discovery Service shutdown completed', LogContext.AI);
    } catch (error) {
      log.error('Error during Model Discovery Service shutdown', LogContext.AI, {
