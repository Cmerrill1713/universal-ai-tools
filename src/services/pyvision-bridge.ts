...
class SafePyVisionBridge {
  ...
  async analyzeImage(
    ...
    return this.execute(async () => {
      try {
        ...
        log.error('Image analysis failed', LogContext.AI, {
          error,
  ...
  async generateEmbedding(imagePath: string | Buffer): Promise<VisionResponse<VisionEmbedding>> {
    return this.execute(async () => {
      try {
        ...
        log.error('Embedding generation failed', LogContext.AI, {
          error,
          imagePath: typeof imagePath === 'string' ? imagePath : 'Buffer',
        });
        throw error;
  ...
  async generateImage(
    ...
    return this.execute(async () => {
      try {
        ...
        log.error('Image generation failed', LogContext.AI, { error, prompt, parameters });
        throw error;
      }
    });
  }
  ...
  async reason(
    ...
    return this.execute(async () => {
      try {
        ...
        log.error('Image reasoning failed', LogContext.AI, {
          error,
          imagePath: typeof imagePath === 'string' ? imagePath : 'Buffer',
          question,
        });
  ...
  async refineImage(
    ...
    return this.execute(async () => {
      try {
        ...
        log.error('Image refinement failed', LogContext.AI, {
          error,
          imagePath: typeof imagePath === 'string' ? imagePath : 'Buffer',
          parameters,
        });
  ...
  async analyzeBatch(
    ...
    return this.execute(async () => {
      try {
        ...
        log.error('Batch image analysis failed', LogContext.AI, { error, imagePaths, options });
        throw error;
      }
    });
  }
  ...
  async shutdown() {
    try {
      ...
      log.error('PyVision shutdown failed', LogContext.AI, { error });
      // Don't re-throw shutdown errors as they're not critical
    }
  }
