...
export class MockLLMService {
  ...
  private initializeResponses() {
    ...
    this.responses.set('synthesizer', {')
      synthesis: {,
        summary: 'Build a secure REST API with JWT authentication, following industry best practices','
        key_recommendations: [
  ...
  password: Joi.string().min(8).required()
    ...
    this.responses.set('personal_assistant', {')
      ...
      confidence: 0.75,
      reasoning: 'Provided project management assistance based on typical API development timelines','
    });
  }
