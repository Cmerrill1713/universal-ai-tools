    ...
    try {
      ...
      const generatedWidget: GeneratedWidget = {
        ...
        metadata: {
          ...
          iterations: 1,
          participatingAgents: ['RequirementsAnalyzer', 'ComponentDesigner', 'CodeGenerator', 'TestGenerator', 'Optimizer']
        }
      };
...
${stateInterface ? `interface ${componentName}State {
${stateInterface}
}` : ''}
...
describe('${componentName}', () => {
  ...
  async improveWidget(
    ...
    const improvedDesign = response.result.design || { componentName: 'ImprovedWidget', props: {}, state: {} };
