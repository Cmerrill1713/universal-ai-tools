...
import type { OptimizedParameters } from '../types/index.js';
...
export function intelligentParametersMiddleware(overrides: ParameterOverrides = {}) {
  return (req: IntelligentRequest, res: Response, next: NextFunction) => {
    try {
      ...
      if (overrides.contextLength !== undefined) {optimizedParams.contextLength = overrides.contextLength;}
      if (overrides.systemPrompt !== undefined) {optimizedParams.systemPrompt = overrides.systemPrompt;}
      ...
      if (req.body.contextLength !== undefined) {optimizedParams.contextLength = req.body.contextLength;}
...
export function optimizeParameters(
  ...
  if (options.overrides) {
    if (options.overrides.temperature !== undefined) {optimizedParams.temperature = options.overrides.temperature;}
    if (options.overrides.maxTokens !== undefined) {optimizedParams.maxTokens = options.overrides.maxTokens;}
    if (options.overrides.contextLength !== undefined) {optimizedParams.contextLength = options.overrides.contextLength;}
    if (options.overrides.systemPrompt !== undefined) {optimizedParams.systemPrompt = options.overrides.systemPrompt;}
  }
