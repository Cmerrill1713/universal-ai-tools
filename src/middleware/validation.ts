...
export const CommonSchemas = {
  ...
  agent: z.object({
    ...
    type: z.enum(['cognitive', 'search', 'analysis', 'generation']),
  ...
  file: z.object({
    ...
    size: z.number().min(1).max(100 * 1024 * 1024), // 100MB limit
...
export const RouteSchemas = {
  ...
  'GET /api/agents': {
    query: CommonSchemas.pagination.extend({
      type: z.enum(['cognitive', 'search', 'analysis', 'generation']).optional(),
