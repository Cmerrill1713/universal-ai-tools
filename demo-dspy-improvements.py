...
agents_table.add_row(
    "System Architect",
    "Design cache layers: Browser → CDN → Redis → Database"
)
agents_table.add_row(
    "Performance Engineer", 
    "Implement LRU eviction, 5-minute TTL for feed items"
)
agents_table.add_row(
    "Data Analyst",
    "Cache hit ratio target: 85%, monitor cache stampede"
)
agents_table.add_row(
    "Security Expert",
    "Ensure user-specific cache keys, prevent data leakage"
)
...
improvements_table.add_row(
    ...
    "Consistent formatting, domain tasks"
)
improvements_table.add_row(
    "Multi-Agent",
