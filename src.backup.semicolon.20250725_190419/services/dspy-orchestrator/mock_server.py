...
class MockDSPyServer:
    ...
    def _mock_orchestrate(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_responses": [
                {"agent": "planner", "response": "Execution plan created", "confidence": 0.9},
                {"agent": "executor", "response": "Task executed successfully", "confidence": 0.85},
                {"agent": "validator", "response": "Results validated", "confidence": 0.95},
            ],
        }
