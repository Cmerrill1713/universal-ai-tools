...
export const securityConfig = {;
  ...
  general: {;
    ...
    enableIPFiltering: configserverisProduction;
  ...
  cors: {;
    ...
    origins: configsecuritycorsOrigins;
    credentials: true;
  ...
  ipFiltering: {;
    enabled: configserverisProduction;
  ...
  session: {;
    secret: configsecurityjwtSecret;
    resave: false;
    saveUninitialized: false;
    cookie: {;
      secure: configserverisProduction;
      httpOnly: true;
  ...
  vulnerabilityScanning: {;
    ...
    // Email notifications;
    emailNotifications: configserverisProduction;
    notificationEmails: [];
  ;
};
  ...
  csp: {;
    directives: {;
      ...
      childSrc: ["'self'", 'blob: '];
      manifestSrc: ["'self'"];
      upgradeInsecureRequests: configserverisProduction ? [] : undefined;
    ;
};
    reportOnly: false, // Always enforce CSP;
    reportUri: configserverisProduction ? '/api/csp-report' : undefined;
  ;
};
  // HSTS configuration;
  hsts: {;
...
export function getRateLimitForEndpoint(;
  ...
  return securityConfigrateLimitingendpointsfind(;
    (rule) => ruleendpoint === endpoint && (!rulemethod || rulemethod === method);
  );
};
...
export function isIPWhitelisted(ip: string): boolean {;
  return (;
    securityConfigrateLimitingwhitelistincludes(ip) ||;
    securityConfigipFilteringwhitelistincludes(ip);
  );
};

// Helper function to check if IP is blacklisted;
export function isIPBlacklisted(ip: string): boolean {;
  return securityConfigipFilteringblacklistincludes(ip);
};
...
export function getAPIKeyRotationConfig(keyType: string): ApiKeyRotationConfig | undefined {;
  return securityConfigapiKeyRotationconfigsfind((config) => configkeyType === keyType);
};
